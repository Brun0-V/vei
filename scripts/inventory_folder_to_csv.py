...
The script intentionally does not browse the web. Fill datasheet_cache.json manually or with an AI agent's
web-search assistance, then rerun this script with --skip-vision to regenerate the CSV.

Works with any coding agent harness (OpenCode, Claude Code, Codex CLI, Cursor, etc.).
"""
...
import vision_inventory_mcp as vision
